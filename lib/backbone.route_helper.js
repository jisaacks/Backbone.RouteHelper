...
(function() {
  ...
  Backbone.History.prototype.loadUrl = function(fragmentOverride) {
    var fragment, handler, helper, params, prefix, query, route;
  ...
  Backbone.RouteHelper = (function() {
    ...
    RouteHelper.prototype.clone = function() {
      var prefix, _clone;
      prefix = this._options.route.helperId || this._options.route.routerClass;
      _clone = new RouteHelper("" + prefix + ":" + this._options.route.name);
