...
(function() {
  ...
  Backbone.RouteHelper = (function() {
    ...
    RouteHelper.omit = function() {
      var keys, _ref;
      keys = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return (_ref = this.current()).omit.apply(_ref, keys);
    };

    RouteHelper.pick = function() {
      var keys, _ref;
      keys = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return (_ref = this.current()).pick.apply(_ref, keys);
    };
    ...
    RouteHelper.prototype.toString = function() {
      return this.route();
    };

    RouteHelper.prototype.replace = function() {
      var args, _ref;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return (_ref = this.route()).replace.apply(_ref, args);
    };
    ...
    RouteHelper.prototype.query = function(args) {
      ...
      _.each(this._options.query, (function(_this) {
        return function(v, k) {
          if (v === void 0 || v === "") {
    ...
    RouteHelper.prototype.omit = function() {
      var keys;
      keys = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      this._useQuery = true;
      this._options.query = _.omit.apply(_, [this._options.query].concat(__slice.call(keys)));
      return this;
    };

    RouteHelper.prototype.pick = function() {
      var keys;
      keys = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      this._useQuery = true;
      this._options.query = _.pick.apply(_, [this._options.query].concat(__slice.call(keys)));
      return this;
    };
